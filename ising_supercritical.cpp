...
private:
    ...
    std::vector<bool> cluster_map;  // Persistent cluster map
    int N;
    double beta;
...
public:
    ...
    void wolff_step() {
        ...
        // Use fixed-size vectors for the stack
        ...
        size_t max_cluster_size = static_cast<size_t>(N) * N / 4;
...
int main() {
    ...
    const double T = 2.32;  // This gives T/T_c = 1.02
    ...
    try {
        ...
        model.save_grid("ising_10000_super.bin");
